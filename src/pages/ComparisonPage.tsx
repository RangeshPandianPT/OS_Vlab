    ...
    <div className="space-y-8">
      ...
      <Card className="p-6">
        <div className="flex flex-wrap gap-4 mb-8">
          <div>
            <label htmlFor="module" className="block text-sm font-medium text-text-muted">Select Module</label>
            <select
              id="module"
              value={module}
              onChange={(e) => setModule(e.target.value)}
              className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-white/40 dark:border-white/10 bg-background focus:outline-none focus:ring-accent focus:border-accent sm:text-sm rounded-md"
            >
